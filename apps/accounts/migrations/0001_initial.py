    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_emoji', models.CharField(choices=[('🧑‍💻', 'Программист'), ('🦸', 'Герой'), ('🧙', 'Маг'), ('🥷', 'Ниндзя'), ('🤖', 'Робот'), ('🦊', 'Лиса'), ('🐉', 'Дракон'), ('🚀', 'Астронавт')], default='🧑‍💻', max_length=10)),
                ('theme', models.CharField(choices=[('dark', 'Тёмная'), ('light', 'Светлая'), ('purple', 'Фиолетовая'), ('ocean', 'Океан'), ('forest', 'Лес'), ('sunset', 'Закат')], default='dark', max_length=20)),
